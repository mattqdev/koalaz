...
describe('DataGenerator', () => {
  describe('generateKoalaData', () => {
    it('should generate a single koala when count is 1', () => {
      const result = DataGenerator.generateKoalaData(1);
    ...
    it('should generate an array of koalas when count > 1', () => {
      const result = DataGenerator.generateKoalaData(5);
      expect(Array.isArray(result)).toBe(true);
      expect((result as KoalaData[]).length).toBe(5);
    });

    it('should generate valid koala IDs', () => {
      const koala = DataGenerator.generateKoalaData(1) as KoalaData;
  ...
  describe('koalaFact', () => {
    it('should return a string', () => {
      const fact = DataGenerator.koalaFact();
